...
exports.resolvePluginId = id => {
  // already full id
  // e.g. std-cli-plugin-foo, @vue/cli-plugin-foo, @bar/std-cli-plugin-foo
  if (pluginRE.test(id)) {
    return id
  }

  if (id === '@sbwcli/cli-service') {
    return id
  }
...
exports.getPluginLink = id => {
  if (officialRE.test(id)) {
    return `https://github.com/vuejs/std-cli/tree/dev/packages/%40vue/cli-plugin-${
